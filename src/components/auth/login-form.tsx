    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} action="/api/auth/login" method="POST" className="space-y-4">
        ...
        <div className="space-y-1.5">
          <label htmlFor="email" className="text-xs font-medium text-[var(--color-text-secondary)] uppercase tracking-wider">
            Email
          </label>
          <input
            id="email"
        ...
        <div className="space-y-1.5">
          <label htmlFor="password" className="text-xs font-medium text-[var(--color-text-secondary)] uppercase tracking-wider">
            Password
          </label>
          <input
            id="password"
